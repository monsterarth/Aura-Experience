...
// produção e o catálogo de módulos como ele existe hoje. Os mocks das telas
// (admin, camareira, portal, mapa) vivem em ./_mocks e reproduzem em HTML/CSS
// a identidade real de cada superfície.
...
export const metadata: Metadata = {
  ...
  description:
    "Da reserva ao pós-estadia: recepção, governança, manutenção, restaurante, comercial e portal do hóspede — um só sistema, em tempo real e white label.",
};

// Renderiza por request (os fetches do supabaseAdmin são no-store): versão,
// changelog e contadores sempre ao vivo. São 8 queries head-only — leve.
export const dynamic = "force-dynamic";

/* ─── dados estáticos (refletem o produto real) ───────────────── */
...
const modules = [
  ...
  },
  {
    ...
    description:
      "Produtos com saldo por local, ciclo de compras com fornecedores e alerta de validade por lote.",
    tags: ["Inventário", "Compras", "Validade"],
  },
  {
    icon: Coffee,
    title: "Café da Manhã",
  ...
  },
  {
    ...
    description:
      "Casamentos com fornecedores, parcelas e cabanas do evento — status atualizado automaticamente pela data.",
    tags: ["Casamentos", "Fornecedores", "Parcelas"],
  },
  {
    icon: ClipboardList,
    title: "Equipe & Ponto",
...
const valueProps = [
  {
    ...
    desc: "Arquitetura multi-tenant: dados isolados por propriedade, com tema e domínio próprios.",
  },
  {
    icon: Palette,
  ...
  },
  {
    ...
    desc: "Sessão validada no servidor, isolamento por RLS e trilha de auditoria de cada ação.",
  },
  {
    icon: Activity,
    title: "Tempo real",
...
export default async function AuraHomePage() {
  const [liveChangelog, version, stats] = await Promise.all([
    getLatestChangelogEntries(16, ["feature"]).catch(() => []),
    ...
    <div className="min-h-screen bg-[#141414] text-white font-sans selection:bg-[#00BFFF]/30 overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-6 md:px-10 py-4 max-w-7xl mx-auto border-b border-white/5 backdrop-blur-md bg-[#141414]/80">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-light text-gray-400">
          <a href="#camaleao" className="hover:text-[#E0FFFF] transition-colors">
            White Label
          </a>
          <a href="#modulos" className="hover:text-[#E0FFFF] transition-colors">
            Módulos
          </a>
          <a href="#apps" className="hover:text-[#E0FFFF] transition-colors">
            Apps de Campo
          </a>
          <a href="#hospede" className="hover:text-[#E0FFFF] transition-colors">
            Portal do Hóspede
          </a>
          <a href="#automacao" className="hover:text-[#E0FFFF] transition-colors">
            Automação
          </a>
      ...
      {/* ══════════════════════════════════════════════════════════
          HERO
      ══════════════════════════════════════════════════════════ */}
      <section className="relative pt-24 pb-28 px-6 max-w-7xl mx-auto">
        {/* dot grid background */}
        <div
        ...
        <div className="relative flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#00BFFF]/10 border border-[#00BFFF]/20 text-[#00BFFF] text-xs font-medium mb-8">
            ...
            <span>
              {version ? `Em produção · v${version}` : "Sistema ativo e em produção"}
            </span>
          </div>
          ...
          <p className="max-w-2xl text-lg md:text-xl text-gray-400 font-light mb-10 leading-relaxed">
            Da reserva ao pós-estadia: recepção, governança, manutenção,
            restaurante, comercial e portal do hóspede — um só sistema, em tempo
            real.
          </p>
        ...
        {/* ── mock fiel do back-office (identidade real do admin) ── */}
      ...
      {/* ══════════════════════════════════════════════════════════
          CAMALEÃO — o white label como ponto central: a mesma tela
          invertendo o contraste (escuro vintage × claro clean)
      ══════════════════════════════════════════════════════════ */}
      <section id="camaleao" className="relative px-6 pb-28 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto text-gray-400 font-light text-lg">
            A mesma tela, o mesmo hóspede, o mesmo código — e duas pousadas que
            não se parecem em nada. Cores, tipografia, cantos e até o
            claro/escuro pertencem à marca de cada propriedade.
          </p>
        </div>

        {/* painel espelho: o fundo inverte junto com a pele */}
        <div className="relative rounded-3xl border border-white/10 overflow-hidden">
          <div className="grid md:grid-cols-2">
            {/* lado escuro — vintage, serifada, cantos retos */}
            <div className="relative bg-[#16110B] px-8 py-14 flex flex-col items-center gap-7">
              ...
              <div className="relative text-center">
                <p className="text-base font-bold text-[#F1E8D9] font-serif">
                  Velho Engenho
                </p>
            ...
            {/* lado claro — clean, geométrica, cantos vivos */}
            <div className="relative bg-[#F3F1EA] px-8 py-14 flex flex-col items-center gap-7">
              <div
                className="absolute inset-0 pointer-events-none opacity-[0.5]"
                style={{
                  backgroundImage:
                    "radial-gradient(circle, #D8D6CE 1px, transparent 1px)",
                  backgroundSize: "26px 26px",
                }}
              />
              <div className="relative transition-transform duration-300 hover:-translate-y-1.5">
              ...
              <div className="relative text-center">
                <p className="text-base font-bold text-[#191A1C] uppercase tracking-[0.2em]">
                  Casa Lume
                </p>
          ...
          {/* medalhão: o camaleão na costura entre os dois mundos */}
        ...
        <div className="flex items-center justify-center gap-2 mt-6 text-xs text-gray-500">
          <Globe size={12} />
          <span>
            Tema aplicado a partir do painel admin — o hóspede nunca vê
            &ldquo;Aura&rdquo;, vê a marca da pousada
          </span>
        </div>
      </section>
      ...
      <section id="modulos" className="py-28 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/8 text-gray-400 text-xs font-medium mb-5">
            <Layers size={12} />
            <span>26 módulos administrativos · 6 apps de campo · 1 portal</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tight mb-4">
          ...
          <p className="max-w-xl mx-auto text-gray-400 font-light text-lg">
            Do balcão da recepção ao pátio da manutenção — tudo no mesmo sistema,
      ...
      {/* ══════════════════════════════════════════════════════════
          APPS DE CAMPO
      ══════════════════════════════════════════════════════════ */}
      <section id="apps" className="py-24 px-6 bg-black/30 border-y border-white/5">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-gray-400 font-light leading-relaxed mb-8 text-lg">
              Cada função abre o sistema já na sua tela de trabalho, direto do
              navegador do celular — sem instalar nada. A tarefa criada na
              recepção aparece no bolso de quem executa, na hora.
            </p>
      ...
      <section id="hospede" className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          {/* mock fiel do portal (tema camaleão real) */}
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-gray-400 font-light leading-relaxed mb-8 text-lg">
              O hóspede escaneia o QR Code e o portal abre com a cara da pousada
              — cores, fontes e textura da marca. Sem baixar nada, no idioma
              dele.
            </p>
            <ul className="space-y-3 mb-8">
              {[
                ...
                "Não Perturbe que a governança recebe na hora",
            ...
            >
              Ver o portal ao vivo <ChevronRight size={14} />
            </a>
          </div>
        </div>
      ...
      {/* ══════════════════════════════════════════════════════════
          ABA EXPLORAR — o diferencial do app do hóspede
      ══════════════════════════════════════════════════════════ */}
      <section className="py-24 px-6 bg-black/30 border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="max-w-2xl mx-auto text-gray-400 font-light text-lg">
              Um mapa ilustrado da propriedade — a arte da sua pousada, não um
              mapa genérico — com GPS ao vivo, tudo o que existe em cada canto e
          ...
          <div className="grid lg:grid-cols-12 gap-14 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col sm:flex-row items-center sm:items-start justify-center gap-8 sm:gap-6">
              <div className="shrink-0 sm:mt-10 transition-transform duration-300 hover:-translate-y-2">
                <ExploreListMock />
                <p className="text-center text-[11px] text-gray-500 mt-3 uppercase tracking-wider">
                  Diretório de áreas
                </p>
              </div>
                ...
                {[
                  {
                    icon: MapPin,
                    color: "#10b981",
                    title: "O mapa ilustrado da sua propriedade",
                    desc: "A pousada desenhada como ela é — trilhas, praia, cada chalé no lugar certo. O hóspede toca num ponto e vê o que é, o horário e como chegar.",
                  },
                  {
                    icon: Navigation,
                    color: "#3b82f6",
                    title: "GPS ao vivo dentro da propriedade",
                    desc: "O ponto azul mostra onde o hóspede está agora, sobre a ilustração. Nada de se perder procurando o restaurante ou o próprio chalé.",
                  },
                  {
                    icon: Activity,
                    color: "#f59e0b",
                    title: "Aberto agora e lotação em tempo real",
                    desc: "Cada área mostra se está aberta e quantos lugares restam — atualizado a cada 30 segundos, direto da operação.",
                  },
                  {
                    icon: CalendarDays,
                    color: "#a78bfa",
                    title: "Reserva de experiências e eventos",
                    desc: "Jacuzzi, quiosque, passeio ou o evento da noite: o hóspede escolhe o horário e reserva do próprio celular.",
                  },
                ].map(({ icon: Icon, color, title, desc }) => (
                  <div
                    key={title}
                    className="flex gap-4 p-4 rounded-2xl bg-white/3 border border-white/5 hover:border-white/10 transition-colors"
                  >
                    <div
              ...
              <div className="flex flex-col sm:flex-row gap-3 p-4 rounded-2xl bg-[#10b981]/5 border border-[#10b981]/15">
                ...
                <p className="text-sm text-gray-400 font-light leading-relaxed">
                  <span className="text-white font-semibold">
                    A ilustração é da propriedade, não do Aura.
                  </span>{" "}
                  Cada pousada sobe a arte do seu mapa e marca os pontos pelo
                  painel — o hóspede reconhece o lugar onde está.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* ══════════════════════════════════════════════════════════
          AUTOMAÇÃO — a rotina que roda sozinha
      ══════════════════════════════════════════════════════════ */}
        ...
        <div className="relative rounded-3xl border border-white/8 bg-gradient-to-br from-[#1a1a2e] via-[#1a1a1a] to-[#141414] p-10 md:p-16 overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-gray-400 font-light leading-relaxed text-lg mb-10 max-w-3xl">
              Estas rotinas rodam sozinhas em produção, todos os dias — ninguém
                ...
                >
                  ...
                  <ul className="space-y-2">
                    {items.map((item) => (
                      <li
                        key={item}
                        className="flex items-start gap-2.5 text-sm text-gray-400 font-light"
                      >
            ...
            {/* IA — como ela é usada de verdade */}
            <div className="flex flex-col sm:flex-row gap-4 p-5 rounded-2xl bg-[#a78bfa]/5 border border-[#a78bfa]/15">
              ...
              <div>
                <p className="text-sm font-semibold text-white mb-1">
                  E IA onde ela ajuda de verdade
                </p>
                <p className="text-sm text-gray-400 font-light leading-relaxed">
                  Pergunte às avaliações: &ldquo;do que os hóspedes mais
                  reclamaram neste mês?&rdquo; — a IA responde com base apenas
                  nos comentários reais coletados nas pesquisas. Sem inventar
                  nada.
                </p>
              </div>
            </div>
      ...
      <section id="valores" className="py-28 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="max-w-xl mx-auto text-gray-400 font-light text-lg">
            Uma plataforma construída do zero para o contexto de pousadas e
            hotéis boutique brasileiros.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <div className="relative">
            ...
            <p className="text-gray-400 font-light text-lg mb-10 max-w-2xl mx-auto">
              Entre em contato para uma demonstração personalizada com os
              módulos mais relevantes para a sua propriedade.
            </p>
            ...
            <div className="flex flex-wrap gap-8 text-sm text-gray-500">
              <div>
                ...
                <div className="space-y-2">
                  <a href="#camaleao" className="block hover:text-gray-300 transition-colors">
                    White Label
                  </a>
                  ...
                  <a href="#automacao" className="block hover:text-gray-300 transition-colors">
                    Automação
                  </a>
