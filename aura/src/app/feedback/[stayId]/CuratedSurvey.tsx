...
const TXT = {
    pt: {
        ...
        recoveryTitle: "Obrigado por contar", recoveryDefault: "Sentimos muito que não tenha sido perfeito. A recepção já foi avisada e vai te procurar para resolver.",
    ...
    en: {
        ...
        recoveryTitle: "Thank you for telling us", recoveryDefault: "We're sorry it wasn't perfect. Reception has been notified and will reach out to make it right.",
    ...
    es: {
        ...
        recoveryTitle: "Gracias por contarnos", recoveryDefault: "Lamentamos que no haya sido perfecto. Recepción fue avisada y te contactará para resolverlo.",
