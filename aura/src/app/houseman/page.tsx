        ...
        <div style={{ background: "rgba(10,12,22,0.95)", borderRadius: 20, padding: 20 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 12, color: T.muted, marginTop: 2 }}>Mensageiro</div>
...
export default function HousemanPage() {
  ...
  const isLoadingScreen = authLoading || !userDataReady || propertyLoading;
  ...
  return (
    <>
      ...
      <div className="dark hm-shell" style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100dvh", background: T.bg }}>
