    ...
    if (!windowOpen && !existingOrder) {
        return (
            <Card pad={22} style={{ textAlign: "center" }}>
                ...
                {windowConfig && <p style={{ margin: "6px 0 0", fontSize: 13, color: "var(--muted)" }}>{t.closedMsg(windowConfig.start, windowConfig.end)}</p>}
            </Card>
        );
    }
