                                                        ...
                                                        {itemSelections.length > 0 && (
                                                            <div className="flex flex-col gap-2">
                                                                {itemSelections.map(sel => (
                                                                    <div key={sel.id} className="flex items-center justify-between bg-primary/10 border border-primary/20 px-3 py-2 rounded-xl text-xs font-semibold text-primary">
                                                                        <div className="flex items-center gap-2">
                                                                            <span className="px-1.5 py-0.5 bg-primary/20 rounded font-black">{sel.quantity}x</span>
                                                                            <span>{sel.flavor}</span>
                                                                        </div>
                                                                        <div className="flex items-center gap-2">
